...
{
    public const SDK_NAME = '2finance-sdk-client';
    ...
    public static function serviceCatalog(): ServiceCatalog
    {
        return ServiceCatalog::fromArray(['services' => self::SERVICE_CATALOG]);
    }
